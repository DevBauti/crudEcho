...
import (
	...
	"github.com/DevBauti/crudEcho/models"
	"github.com/DevBauti/crudEcho/responses"
...
func GetAUser(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, responses.UserResponse{Status: http.StatusOK, Message: "ok", Data: &echo.Map{"data": user}})
}
